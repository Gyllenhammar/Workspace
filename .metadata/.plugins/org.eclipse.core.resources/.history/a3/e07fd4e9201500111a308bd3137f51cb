...
public class Gui {
	...
	public Gui(){
		...
		// Här skapar jag objekt av allt som ska användas i framen!
		
		l_text1 = new JLabel("Namn");
		l_text2 = new JLabel("Kontonummer");
		l_text3 = new JLabel("Insättning");
		...
		b_button3 = new JButton("Sök");
		b_button4 = new JButton("Ta Ut");
		b_button5 = new JButton("Sätt in");
		b_button6 = new JButton("Rensa fält");
		
		// Här skapar jag alla paneler!
		...
		// Här sättar jag vilket layoutmanager som panelerna ska använda!
		...
		// här lägger jag in alla paneler i bakgrundspaneler (huvudpanelen)!
		...
		// här lägger jag in alla komponenter i panelerna!
		...
		b_button3.addActionListener(new ActionListener()  //sök
		{  
		   public void actionPerformed(ActionEvent e)  
		   {  
			   try{
				   ...
				   JOptionPane.showMessageDialog(pane, "Du måste skriva in ett kontonummer!");
			   }
		...
		b_button5.addActionListener(new ActionListener()  //sätt in
		{  
		   public void actionPerformed(ActionEvent e)  
		   {  
		      // do something for this button press  
		...
		b_button6.addActionListener(new ActionListener()  //rensa fält
		{  
		   public void actionPerformed(ActionEvent e)  
		   {  
		      // do something for this button press  
